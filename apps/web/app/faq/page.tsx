...
const FaqPage = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-muted/40 via-background to-accent/15">
      <div className="border-b border-border bg-linear-to-r from-primary/10 via-background to-secondary/10">
