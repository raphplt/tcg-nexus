    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="text-center p-3 bg-muted rounded">
          <div className="text-2xl font-bold text-blue-600">{ranking.points}</div>
        ...
        <div className="text-sm space-y-2">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium">
              {totalGames > 0 ? (ranking.points / totalGames).toFixed(2) : "0.00"}
            </span>
          </div>
...
export function RankingsDisplay({ rankings, tournament, isLoading }: RankingsDisplayProps) {
  ...
  const getRankBadge = (rank: number) => {
    if (rank === 1) return <Badge className="bg-yellow-500 hover:bg-yellow-600">1er</Badge>;
          ...
          <Table>
            ...
            <TableBody>
              {rankings.map((ranking, index) => {
                ...
                const rowClass = isTop3 ? "bg-gradient-to-r from-yellow-50 to-transparent" : "";
                ...
                return (
                  <TableRow key={ranking.id} className={rowClass}>
                    ...
                    <TableCell className="text-center">
                      <span className="font-bold text-lg">{ranking.points}</span>
                    </TableCell>
                    ...
                    <TableCell className="text-center">
                      <span className={`font-medium ${getWinRateColor(ranking.winRate)}`}>
                    ...
                    <TableCell className="text-center">
                      <Dialog>
                        ...
                        <DialogContent>
                          ...
                          <PlayerStats ranking={ranking} tournament={tournament} />
                        </DialogContent>
                      </Dialog>
                    </TableCell>
                  </TableRow>
      ...
      <Card className="mt-6">
        ...
        <CardContent>
          <div className="text-sm text-muted-foreground space-y-2">
            {tournament?.type === "swiss_system" && (
              <>
                <p>• <strong>Victoire :</strong> 3 points</p>
                <p>• <strong>Égalité :</strong> 1 point</p>
                <p>• <strong>Défaite :</strong> 0 point</p>
                <p>• <strong>Bye :</strong> 3 points (victoire automatique)</p>
              </>
            )}
            ...
            {(tournament?.type === "single_elimination" || tournament?.type === "double_elimination") && (
              <>
                <p>• <strong>Victoire :</strong> 1 point (progression)</p>
                <p>• <strong>Défaite :</strong> 0 point (élimination)</p>
              </>
            )}
            <p className="pt-2 border-t">
              <strong>Départage :</strong> En cas d'égalité de points, le classement se fait par % de victoires, puis par nombre de victoires.
            </p>
          </div>
        </CardContent>
      </Card>
