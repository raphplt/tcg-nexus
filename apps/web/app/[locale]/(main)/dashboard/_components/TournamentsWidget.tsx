...
export function TournamentsWidget({ data }: TournamentsWidgetProps) {
  const t = useTranslations("Dashboard.tournaments");
        ...
        {isEmpty ? (
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div>
                <span className="text-muted-foreground">{t("bestRank")}</span>
            ...
            <div className="flex items-center gap-3 text-xs text-muted-foreground">
              <span className="text-green-600 font-medium">
                {t("wins", { count: data.totalWins })}
              </span>
              <span className="text-red-500 font-medium">
                {t("losses", { count: data.totalLosses })}
              </span>
            </div>
          </div>
        )}
