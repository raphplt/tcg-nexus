                           ...
                           {user && deck.user && user.id === deck.user.id && (
                               <TableCell className="align-content-end">
                                   <div className="opacity-0 group-hover:opacity-100 transition flex justify-end pr-2">
                                       <Button className="mr-2" size="sm" variant="secondary" onClick={(e) => {
                                           e.stopPropagation();
           ...
           <AlertDialogContent>
               <AlertDialogHeader>
                   ...
                   <AlertDialogDescription>
                       Cette action est irréversible. Cela supprimera définitivement le deck.
                   </AlertDialogDescription>
               </AlertDialogHeader>
               <AlertDialogFooter>
                   <AlertDialogCancel>Annuler</AlertDialogCancel>
                   <AlertDialogAction onClick={()=> deleteDeck(selectedDeckId)}>Continue</AlertDialogAction>
               </AlertDialogFooter>
           </AlertDialogContent>
       </AlertDialog>
