...
export class MarketplaceCheckout1785974400000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Existing records lack a snapshot: reconstruct snapshot fields from corresponding listing entity
    await queryRunner.query(`
  ...
  // Constraint name generated by TypeORM synchronization is a hash; look up via table and column name
